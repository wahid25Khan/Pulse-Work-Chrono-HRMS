...
export default class PerformanceReview extends LightningElement {
    ...
    @api achievementsTitle = 'Special Initiatives, Achievements, contributions if any';
    ...
    loadComponentData() {
        ...
        this.profExcellenceRows = [
            { id: 1, kra: 'Production', kpi: 'Quality', weight: 30, isParent: true, rowSpan: 2 },
            { id: 2, kra: 'Production', kpi: 'TAT (turn around time)', weight: 30, isParent: false },
            { id: 3, kra: 'Process Improvement', kpi: 'PMS, New Ideas', weight: 10, isParent: true }
        ];

        // 3. Personal Excellence
        this.personalExcellenceRows = [
            { id: 1, attr: 'Attendance', indicator: 'Planned/Unplanned Leaves', weight: 2, rowSpan: 2, isParent: true },
            { id: 2, attr: 'Attendance', indicator: 'Time Consciousness', weight: 2, isParent: false }
        ];
    ...
    handleAddRow(event) {
        ...
        if (table === 'achievements') {
            ...
            this.achievementRows = [...this.achievementRows, { id: newId, self: '', ro: '', hod: '' }];
        }
    }
}