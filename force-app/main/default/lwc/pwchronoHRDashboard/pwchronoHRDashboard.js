...
export default class PwchronoHRDashboard extends LightningElement {
    ...
    get onTimeTotal() {
        return (this.summary?.onTimeTrend || []).reduce((a, b) => a + Number(b || 0), 0) || 82;
    }

    get lateTotal() {
        return (this.summary?.lateTrend || []).reduce((a, b) => a + Number(b || 0), 0) || 11;
    }

    get absentTotal() {
        return (this.summary?.absentTrend || []).reduce((a, b) => a + Number(b || 0), 0) || 6;
    }
    ...
    get lateArrivalRows() {
        ...
        return [
            { key: "late-1", employeeName: "Jessica Brown", department: "Customer Support", arrivalTime: "10:15 AM", lateBy: "+15 Min", avatar: this.userAvatarPath("user-01.jpg") },
            { key: "late-2", employeeName: "Amanda Lewis", department: "HR Admin", arrivalTime: "10:25 AM", lateBy: "+25 Min", avatar: this.userAvatarPath("user-02.jpg") },
            { key: "late-3", employeeName: "James Clark", department: "Sales", arrivalTime: "11:00 AM", lateBy: "+1 Hr", avatar: this.userAvatarPath("user-03.jpg") },
            { key: "late-4", employeeName: "Amanda Davis", department: "Administration", arrivalTime: "09:40 AM", lateBy: "+20 Min", avatar: this.userAvatarPath("user-04.jpg") },
            { key: "late-5", employeeName: "Lisa Anderson", department: "Finance", arrivalTime: "09:35 AM", lateBy: "+15 Min", avatar: this.userAvatarPath("user-05.jpg") }
        ];
    }
    ...
    get pendingApprovalRows() {
        ...
        return [
            { key: "pending-1", employeeName: "Hendrik Markel", dateAndDays: "12 Jan 2024 • 4 days", reason: "Family Trip", avatar: this.userAvatarPath("user-16.jpg") },
            { key: "pending-2", employeeName: "Michael Brown", dateAndDays: "11 Jan 2024 • 2 days", reason: "Medical Appointment", avatar: this.userAvatarPath("user-17.jpg") },
            { key: "pending-3", employeeName: "Daniel Martinez", dateAndDays: "10 Jan 2024 • 2 days", reason: "Personal Work", avatar: this.userAvatarPath("user-18.jpg") }
        ];
    }
    ...
    get upcomingInterviewRows() {
        ...
        return [
            { key: "interview-1", title: "UI/UX Design Interview", timeRange: "11:00 AM - 11:30 AM" },
            { key: "interview-2", title: "Senior Developer React", timeRange: "01:00 PM - 02:00 PM" }
        ];
    }
    ...
    get topEmployeeRows() {
        ...
        if (Array.isArray(rows) && rows.length) {
            return rows.map((row, idx) => ({
                key: row.key || `top-${idx}`,
                employeeName: row.employeeName || "Employee",
                avatar: row.photoUrl || this.userAvatarPath(`user-${String(idx + 6).padStart(2, "0")}.jpg`)
            }));
        }

        return [
            { key: "top-1", employeeName: "Employee", avatar: this.userAvatarPath("user-06.jpg") },
            { key: "top-2", employeeName: "Employee", avatar: this.userAvatarPath("user-07.jpg") },
            { key: "top-3", employeeName: "Employee", avatar: this.userAvatarPath("user-08.jpg") },
            { key: "top-4", employeeName: "Employee", avatar: this.userAvatarPath("user-09.jpg") },
            { key: "top-5", employeeName: "Employee", avatar: this.userAvatarPath("user-10.jpg") },
            { key: "top-6", employeeName: "Employee", avatar: this.userAvatarPath("user-11.jpg") },
            { key: "top-7", employeeName: "Employee", avatar: this.userAvatarPath("user-12.jpg") },
            { key: "top-8", employeeName: "Employee", avatar: this.userAvatarPath("user-13.jpg") },
            { key: "top-9", employeeName: "Employee", avatar: this.userAvatarPath("user-14.jpg") },
            { key: "top-10", employeeName: "Employee", avatar: this.userAvatarPath("user-15.jpg") }
        ];
    }
    ...
    async renderedCallback() {
        ...
        try {
            ...
            await Promise.all([
                ...
                loadStyle(this, `${SMARTHR_ASSETS}/assets/plugins/fontawesome/css/all.min.css`),
                loadStyle(this, `${SMARTHR_ASSETS}/assets/plugins/icons/feather/feather.css`),
                loadStyle(this, `${SMARTHR_ASSETS}/assets/plugins/tabler-icons/tabler-icons.min.css`),
    ...
    initCharts() {
        ...
        this.createChart("attendanceChart", {
            type: "bar",
            data: {
                labels: this.summary?.attendanceLabels || ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
                datasets: [
                    {
                        label: "On-Time",
                        data: this.summary?.onTimeTrend || [520, 320, 280, 640, 410, 600, 590],
                        borderWidth: 0
                    },
                    {
                        label: "Late",
        ...
        const distConfig = (values) => ({
            type: "bar",
            data: {
                labels: this.summary?.distributionLabels || ["Sales", "Front End", "React", "UI"],
        ...
        this.createChart("imageChart", distConfig(this.summary?.distributionToday || [40, 25, 36, 19]));
        this.createChart("imageChartWeek", distConfig(this.summary?.distributionWeek || [38, 22, 31, 17]));
        this.createChart("imageChartMonth", distConfig(this.summary?.distributionMonth || [42, 28, 34, 21]));
        this.createChart("imageChartQuarter", distConfig(this.summary?.distributionQuarter || [41, 24, 33, 20]));
        this.createChart("imageChartYear", distConfig(this.summary?.distributionYear || [45, 26, 33, 18]));
        ...
        this.createChart("training-chart", {
            ...
            data: {
                ...
                datasets: [{ data: [this.summary?.trainingInProgress ?? 80, this.summary?.trainingCompleted ?? 120], borderWidth: 0 }]
            },
            options: {
                responsive: true,
                plugins: { legend: { display: false } },
        ...
        this.createChart("deductionChart", {
            ...
            data: {
                ...
                datasets: [{ label: "Deductions", data: this.summary?.deductionSparkline || [8, 10, 9, 12, 11, 13], tension: 0.35, pointRadius: 0 }]
            },
            options: {
                responsive: true,
                plugins: { legend: { display: false } },
        ...
        this.createChart("payrollChart", {
            ...
            data: {
                labels: ["W1", "W2", "W3", "W4", "W5", "W6"],
                datasets: [{ label: "Payroll", data: this.summary?.payrollSparkline || [2.1, 2.2, 2.18, 2.25, 2.32, 2.4], tension: 0.35, pointRadius: 0 }]
            },
            options: {
                responsive: true,
                plugins: { legend: { display: false } },
