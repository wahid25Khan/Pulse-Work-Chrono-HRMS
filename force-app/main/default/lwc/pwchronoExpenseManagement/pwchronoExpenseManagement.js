...
export default class PwchronoExpenseManagement extends LightningElement {
  ...
  get isDashboardTab() {
    return !this.isDetailView && this.activeTab === TAB_DASHBOARD;
  }
  get isMyClaimsTab() {
    return !this.isDetailView && this.activeTab === TAB_MY_CLAIMS;
  }
  get isApprovalsTab() {
    return !this.isDetailView && this.activeTab === TAB_APPROVALS;
  }
  ...
  get dashboardTabClass() {
    return this.tabClass(TAB_DASHBOARD);
  }
  get myClaimsTabClass() {
    return this.tabClass(TAB_MY_CLAIMS);
  }
  get approvalsTabClass() {
    return this.tabClass(TAB_APPROVALS);
  }

  // ── Tab handlers ──────────────────────────────────────────────────────────

  handleTabDashboard() {
    this.activeTab = TAB_DASHBOARD;
  }
  handleTabMyClaims() {
    this.activeTab = TAB_MY_CLAIMS;
  }
  handleTabApprovals() {
    this.activeTab = TAB_APPROVALS;
  }
