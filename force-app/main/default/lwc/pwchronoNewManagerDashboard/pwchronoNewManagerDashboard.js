...
export default class PwchronoNewManagerDashboard extends LightningElement {
    ...
    smarthrAssetsAvatar24_1 = smarthrAssets + '/assets/img/profiles/avatar-24.jpg';
    smarthrAssetsAvatar23 = smarthrAssets + '/assets/img/profiles/avatar-23.jpg';
    smarthrAssetsAvatar27_1 = smarthrAssets + '/assets/img/profiles/avatar-27.jpg';
    smarthrAssetsAvatar29_1 = smarthrAssets + '/assets/img/profiles/avatar-29.jpg';
    ...
    smarthrAssetsAvatar06_1 = smarthrAssets + '/assets/img/profiles/avatar-06.jpg';
    smarthrAssetsAvatar08_1 = smarthrAssets + '/assets/img/profiles/avatar-08.jpg';
    smarthrAssetsAvatar09_2 = smarthrAssets + '/assets/img/profiles/avatar-09.jpg';
    ...
    smarthrAssetsAvatar06_2 = smarthrAssets + '/assets/img/profiles/avatar-06.jpg';
    smarthrAssetsAvatar08_2 = smarthrAssets + '/assets/img/profiles/avatar-08.jpg';
    smarthrAssetsAvatar09_3 = smarthrAssets + '/assets/img/profiles/avatar-09.jpg';
    ...
    smarthrAssetsAvatar17_1 = smarthrAssets + '/assets/img/profiles/avatar-17.jpg';
    ...
    renderedCallback() {
        ...
        Promise.all([
            ...
            loadStyle(this, smarthrAssets + '/assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css'),
            loadStyle(this, smarthrAssets + '/assets/plugins/tabler-icons/tabler-icons.min.css'),
            loadStyle(this, smarthrAssets + '/assets/plugins/select2/css/select2.min.css'),
            loadStyle(this, smarthrAssets + '/assets/plugins/flatpickr/flatpickr.min.css'),
            loadStyle(this, smarthrAssets + '/assets/plugins/daterangepicker/daterangepicker.css'),
            loadStyle(this, smarthrAssets + '/assets/plugins/fontawesome/css/all.min.css'),
            loadStyle(this, smarthrAssets + '/assets/plugins/icons/feather/feather.css')
        ]).then(() => {
    ...
    initializeEmpDepartmentChart() {
        const ctx = this.template.querySelector('canvas.emp-department').getContext('2d');
    ...
    initializeAttendanceChart() {
        const ctx = this.template.querySelector('canvas.attendance').getContext('2d');
        new window.Chart(ctx, {
            type: 'doughnut',
            data: {
    ...
    initializeSalesIncomeChart() {
        const ctx = this.template.querySelector('canvas.sales-income').getContext('2d');
        new window.Chart(ctx, {
            type: 'bar',
            data: {
    ...
    initializeMySemiDonutChart() {
        const ctx = this.template.querySelector('canvas.mySemiDonutChart').getContext('2d');
        new window.Chart(ctx, {
            type: 'doughnut',
            data: {
