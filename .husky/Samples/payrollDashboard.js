...
export default class PayrollDashboard extends LightningElement {
	...
	initCharts() {
		...
		this._charts.push(this.createBatchSparkline('batchProcessChart1', [10, 14, 13, 18, 16, 20, 19]));
		this._charts.push(this.createBatchSparkline('batchProcessChart2', [4, 6, 7, 8, 7, 9, 8]));
		this._charts.push(this.createBatchSparkline('batchProcessChart3', [5, 7, 8, 9, 9, 10, 11]));

		this._charts.push(this.createTrendChart());

		this._charts.push(this.createMiniBars('insuranceMiniChart', [3, 5, 4, 6, 5, 7, 6]));
		this._charts.push(this.createMiniBars('contributionMiniChart', [2, 3, 3, 4, 4, 5, 4]));
		this._charts.push(this.createMiniBars('healthMiniChart', [2, 2, 3, 3, 4, 4, 5]));
	}
